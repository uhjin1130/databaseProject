...
CREATE TABLE `edithistory` (
  `Edit_Num` int NOT NULL,
  `Admin_ID` varchar(20) NOT NULL,
  `EditRequest_Num` int NOT NULL,
  `Content` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Edit_Num`),
  KEY `Admin_ID_idx` (`Admin_ID`),
  KEY `EditRequest_Num_idx` (`EditRequest_Num`),
  CONSTRAINT `Admin_ID` FOREIGN KEY (`Admin_ID`) REFERENCES `admins` (`Admin_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `EditRequest_Num` FOREIGN KEY (`EditRequest_Num`) REFERENCES `editrequest` (`EditRequest_Num`),
  CONSTRAINT `fk_editrequest_num` FOREIGN KEY (`EditRequest_Num`) REFERENCES `editrequest` (`EditRequest_Num`)
...
INSERT INTO `edithistory` VALUES (1,'admin',7,'수정테스트');
