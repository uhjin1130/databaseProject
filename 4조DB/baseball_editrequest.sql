...
CREATE TABLE `editrequest` (
  `EditRequest_Num` int NOT NULL AUTO_INCREMENT,
  `Member_ID` varchar(20) NOT NULL,
  `Content` varchar(100) NOT NULL,
  PRIMARY KEY (`EditRequest_Num`,`Member_ID`),
...
LOCK TABLES `editrequest` WRITE;
/*!40000 ALTER TABLE `editrequest` DISABLE KEYS */;
INSERT INTO `editrequest` VALUES (1,'zxcv','가나다'),(7,'zxcv','테스트'),(11,'uhjin1130','테스트입니다');
/*!40000 ALTER TABLE `editrequest` ENABLE KEYS */;
UNLOCK TABLES;
